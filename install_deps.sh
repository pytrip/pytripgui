...
apt_install() {
    PYTHON_VERSION=$1
    apt-get -q update
    PYTHON2_CMD="apt-get install -y python-numpy python-scipy python-matplotlib python-tk python-wxgtk2.8"
    PYTHON3_CMD="apt-get install -y python3-numpy python3-scipy python3-matplotlib python-wxgtk2.8"
